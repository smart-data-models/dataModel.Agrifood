...
hasAgriProductType = ['urn:ngsi-ld:AgriProductType:06afffde-4488-11e8-861a-cfcf50aaa9cc', 'urn:ngsi-ld:AgriProductType:0c094486-4488-11e8-a15f-afa816790c64', 'urn:ngsi-ld:AgriProductType:14bf9f26-4488-11e8-9e3d-bfb78de66dd3']
attribute = "hasAgriProductType"
value = hasAgriProductType
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

relatedSource = [{'application': 'urn:ngsi-ld:AgriApp:72d9fb43-53f8-4ec8-a33c-fa931360259a', 'applicationEntityId': 'app:farm1'}]
