...
category = {'type': 'Property', 'value': ['TBD']}
attribute = "category"
value = category
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

endpoint = "{'type': 'Property', 'value': 'https://app.endpoint/download'}"
attribute = "endpoint"
value = endpoint
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

hasProvider = "{'type': 'Relationship', 'object': 'urn:ngsi-ld:Organization:fce9dcbc-4479-11e8-9de1-cb228de7a15c'}"
