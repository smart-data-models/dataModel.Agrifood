...
class AnimalDisease(BaseModel):
    ...
    date: Optional[AwareDatetime] = Field(
        None, description='Date of diagnosis of the disease by a veterinarian'
    )
    ...
    diagnosticTest: Optional[str] = Field(
        None,
