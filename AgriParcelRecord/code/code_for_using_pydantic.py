...
class Type6(Enum):
    AgriParcelRecord = 'AgriParcelRecord'


class AgriParcelRecord(BaseModel):
    ...
    atmosphericPressure: Optional[float] = Field(
        None, description='Atmospheric Pressure nominally in units of hecto Pascals'
    )
    ...
    leafRelativeHumidity: Optional[confloat(ge=0.0, le=1.0)] = Field(
        None, description='Relative humidity on the surface of the leaves'
    )
    leafTemperature: Optional[float] = Field(
        None,
        description='The observed leaf temperature nominally in degrees centigrade',
    )
    leafWetness: Optional[confloat(ge=0.0, le=1.0)] = Field(
        None,
    ...
    soilSalinity: Optional[float] = Field(
        None, description='It is the salt content in the soil'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity Type. It has to be AgriParcelRecord'
    )
