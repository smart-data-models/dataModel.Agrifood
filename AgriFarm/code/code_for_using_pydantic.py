...
class ContactPoint(BaseModel):
    ...
    faxNumber: Optional[str] = Field(None, description='The fax number of the item')
...
class AgriFarm(BaseModel):
    ...
    type: Optional[Type12] = Field(
        None, description='NGSI Entity Type. It has to be AgriFarm'
    )
